  ...
  <div class="video">
    <div class="video-title">
      <el-button type="primary"
                 plain
                 @click="dialogAddVisible=true">点击添加精彩瞬间</el-button>
    </div>
    <el-table :data="videos"
      ...
      <el-table-column label="视频"
        ...
        <template slot-scope="scope">
          <video @play="meIsPlaying(scope.$index)"
                 :src="scope.row.url"
                 :ref="'video'+scope.$index"
                 controls
                 width="240px"> </video>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button size="medium"
                     type="primary"
                     @click="handleEdit(scope.row)">修改描述</el-button>
          <el-button size="medium"
                     type="danger"
    ...
    <el-dialog title="修改框"
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="editSuccess(editId)">确 定</el-button>
      </div>
    </el-dialog>

    <!--新增弹窗-->
    <el-dialog title="新增精彩瞬间"
      ...
      <el-form :model="add">
        <el-upload class="upload-demo"
          ...
          <el-button type="primary"
                     plain>点击上传视频与封面</el-button>
          <div slot="tip"
               class="el-upload__tip">切记同时选择2个文件，分别为视频mp4文件和封面jpg/png文件</div>
        </el-upload>
