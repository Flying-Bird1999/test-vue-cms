    ...
    <div class="banners">
        <div class="banners-title">
            <el-upload
                ...
                <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb，最多选择3张图片</div>
            </el-upload>
        </div>
        <div class="banners-con">
            <div class="item" v-for="banner in banners" :key="banners.id">
                <img :src="banner.image" class="item-pic">
                <div class="icon" @click="delBanners(banner.id)">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 限制最多选择图片的张数
            handleExceed(files) {
                this.$message.warning(`当前限制选择 9 个文件，本次选择了 ${files.length} 个文件`);
            },
            // 新增轮播图
            addFiles(params){
                // FormData格式
