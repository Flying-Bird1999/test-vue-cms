<template>
  <div class="competition">
    <el-button type="primary"
               ...
               @click="addCompetition">点击新增比赛</el-button>
    <el-table :data="competition"
      ...
      <el-table-column label="状态"
        ...
        <template slot-scope="scope">
          <el-tag size="medium"
                  :type="scope.row.status | statusStyleFilter">{{ scope.row.status | statusFilter }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="队伍A"
                       width="120"
                       align="center">
        <template slot-scope="scope">
    ...
    <!--新增比赛弹窗-->
    <el-dialog title="新增比赛"
               :visible.sync="dialogAddVisible"
               width="35%">
      <el-form :model="addGame">
        <el-form-item label="比赛时间"
                      label-width="80px"
                      style="margin-top: 20px; marginLeft: 30px">
          <el-date-picker v-model="addGame.time"
                          type="datetime"
                          placeholder="选择日期时间"
        ...
        <el-form-item label="赛事小组"
                      label-width="80px"
                      style="margin-top: 20px; marginLeft: 30px">
          <el-select v-model="addGame.team_group"
                     placeholder="请选择赛事小组"
                     style="width: 230px">
        ...
        <el-form-item label="赛事性质"
          ...
          <el-select v-model="addGame.team_status"
                     placeholder="请选择赛事性质"
                     style="width: 230px">
            <el-option label="小组赛"
                       value="小组赛"></el-option>
        ...
        <el-form-item label="队伍A"
                      ...
                      label-width="80px"
                      style="marginLeft: 30px">
          <el-select v-model="addGame.teamNameA"
                     placeholder="请选择参赛队伍"
                     style="width: 230px">
        ...
        <el-form-item label="队伍B"
                      ...
                      label-width="80px"
                      style="marginLeft: 30px">
          <el-select v-model="addGame.teamNameB"
                     placeholder="请选择参赛队伍"
                     style="width: 230px">
            <el-option v-for="team in teams"
                       :key="team.id"
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="addSuccess">确 定</el-button>
      </div>
    </el-dialog>

    <!--编辑弹窗-->
    <el-dialog title="编辑赛事"
      ...
      <el-form :model="editGame"
        ...
        <el-form-item label="比赛时间"
                      prop="time"
                      label-width="80px">
          <el-date-picker v-model="editGame.time"
                          type="datetime"
                          placeholder="选择日期时间"
                          default-time="12:00:00"
                          style="width: 220px">
        ...
        <el-form-item label="性质"
                      prop="team_status"
                      label-width="80px">
          <el-select v-model="editGame.team_status"
                     placeholder="请选择赛事性质"
                     style="width: 220px">
            <el-option label="小组赛"
                       value="小组赛"></el-option>
        ...
        <el-form-item label="赛事小组"
                      label-width="80px">
          <el-select v-model="editGame.team_group"
                     placeholder="请选择赛事小组"
                     style="width: 220px">
            <el-option v-for="(group,i) in groupArr"
                       :key="i"
        ...
        <el-form-item label="状态"
                      prop="status"
                      label-width="80px">
          <el-select v-model="editGame.status"
                     placeholder="请选择赛事性质"
                     style="width: 220px">
            <el-option label="未开始"
                       :value="status.noStart"></el-option>
            <el-option label="已结束"
                       :value="status.end"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="队伍A"
                      prop="teamNameA"
                      label-width="80px">
          <el-select v-model="editGame.teamNameA"
                     placeholder="请选择参赛队伍"
                     style="width: 220px">
            <el-option v-for="team in teams"
                       :key="team.id"
        ...
        <el-form-item label="得分"
                      prop="countA"
                      label-width="80px">
          <el-input v-model="editGame.countA"
                    autocomplete="off"
        ...
        <el-form-item label="队伍B"
                      prop="teamNameB"
                      label-width="80px">
          <el-select v-model="editGame.teamNameB"
                     placeholder="请选择参赛队伍"
                     style="width: 220px">
            <el-option v-for="team in teams"
                       :key="team.id"
        ...
        <el-form-item label="得分"
                      prop="countB"
                      label-width="80px">
          <el-input v-model="editGame.countB"
                    autocomplete="off"
                    style="width: 220px"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="editSuccess()">确 定</el-button>
      </div>
    </el-dialog>

    <!--录入比赛技术统计弹窗-->
    <el-dialog title="技术统计"
      ...
      <div class="dialogScore">
        <div class="scoreA">
          ...
          <el-form :model="teamBehavior"
                   ref="teamBehavior">
            <el-table :data="teamBehavior.behaviorA"
                      style="width: 100%">
              ...
              <el-table-column label="得分"
                               ...
                               align="center">
                <template slot-scope="scope">
                  <el-form-item :prop="'behaviorA.' + scope.$index + '.point'"
              ...
              <el-table-column label="篮板"
                               ...
                               align="center">
                <template slot-scope="scope">
                  <el-form-item :prop="'behaviorA.' + scope.$index + '.backboard'"
                                style="padding: 0;margin: 0;">
              ...
              <el-table-column label="助攻"
                               ...
                               align="center">
                <template slot-scope="scope">
                  <el-form-item :prop="'behaviorA.' + scope.$index + '.assist'"
                                style="padding: 0;margin: 0;">
                    <el-input v-model="scope.row.assist"></el-input>
                  </el-form-item>
                </template>
              </el-table-column>
              <el-table-column label="犯规"
                               width="80"
                               align="center">
                <template slot-scope="scope">
                  <el-form-item :prop="'behaviorA.' + scope.$index + '.foul'"
                                style="padding: 0;margin: 0;">
        ...
        <div class="scoreB">
          ...
          <el-form :model="teamBehavior">
            <el-table :data="teamBehavior.behaviorB"
                      style="width: 100%">
              <el-table-column prop="name"
                               label="姓名"
                               width="80"
              ...
              <el-table-column prop="point"
                               ...
                               align="center">
                <template slot-scope="scope">
                  <el-form-item :prop="'behaviorB.' + scope.$index + '.point'"
                                style="padding: 0;margin: 0;">
                    <el-input v-model="scope.row.point"></el-input>
                  </el-form-item>
                </template>
              </el-table-column>
              <el-table-column prop="backboard"
                               label="篮板"
                               width="80"
                               align="center">
                <template slot-scope="scope">
                  <el-form-item :prop="'behaviorB.' + scope.$index + '.backboard'"
                                style="padding: 0;margin: 0;">
                    <el-input v-model="scope.row.backboard"></el-input>
                  </el-form-item>
                </template>
              ...
              <el-table-column prop="assist"
                               ...
                               align="center">
                <template slot-scope="scope">
                  <el-form-item :prop="'behaviorB.' + scope.$index + '.assist'"
                                style="padding: 0;margin: 0;">
                    <el-input v-model="scope.row.assist"></el-input>
                  </el-form-item>
                </template>
              </el-table-column>
              <el-table-column prop="foul"
                               label="犯规"
                               width="80"
                               align="center">
                <template slot-scope="scope">
                  <el-form-item :prop="'behaviorB.' + scope.$index + '.foul'"
                                style="padding: 0;margin: 0;">
                    <el-input v-model="scope.row.foul"></el-input>
                  </el-form-item>
                </template>
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="scoreSuccess()">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
